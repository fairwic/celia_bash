...
def close_ad():
     if exists(Template(r"tpl1750328442493.png", record_pos=(0.299, -0.831), resolution=(720, 1280))):
            keyevent("back")
            return
     if exists(Template(r"tpl1746184976411.png", record_pos=(0.444, -0.837), resolution=(540, 960))):
        ...
        # 等待20秒广告结束
            ...
            return
     elif exists(Template(r"tpl1749708765909.png", record_pos=(-0.237, 0.782), resolution=(900, 1600))):
            touch(Template(r"tpl1749708765909.png", record_pos=(-0.237, 0.782), resolution=(900, 1600)))
            return
     elif exists(Template(r"tpl1749780776910.png", record_pos=(-0.281, 0.629), resolution=(900, 1600))):
